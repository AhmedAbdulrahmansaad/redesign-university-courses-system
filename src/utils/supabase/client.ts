...
// Helper that returns the initialized client or attempts to create one,
// throwing a clear error if credentials are missing.
export function getClientOrThrow(): SupabaseClient {
  if (supabase) return supabase;
  // createClient will validate and throw a helpful error if envs are missing
  return createClient();
}
