...
/* Table schema:
CREATE TABLE kv_store_1573e40a (
  key TEXT NOT NULL PRIMARY KEY,
  value JSONB NOT NULL
);
*/

// View at https://supabase.com/dashboard/project/kcbxyonombsqamwsmmqz/database/tables
...
export const set = async (key: string, value: any): Promise<void> => {
  ...
  const { error } = await supabase.from("kv_store_1573e40a").upsert({
    key,
    value
  });
  if (error) {
